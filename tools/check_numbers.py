...
STRUCTURAL_NUMBERS = {
    ...
    "3": "an exit code",
    "4": "an exit code",
    "5": "a count of gates or scenarios",
    ...
    "2000": "bootstrap resamples, and a comparison count",
    "5000": "gated comparisons in the sweep",
    "0.5": "the pass boundary",
    "0.05": "the configured significance level",
    "0.02": "the configured mean drop threshold",
    "0.17": "the configured flip rate limit",
    "0.06": "the run to run noise, and the flip limit this build first shipped",
    "0.22": "the item to item noise",
    "0.80": "the configured power",
    "0.8": "the configured power",
    "0.01": "the minimum movement filter, and a claimed rate",
    "0.005": "the near zero window in exp04",
    "0.001": "a claimed rate",
    "250": "the replication count in the war story",
    "001": "an ADR number",
    "002": "an ADR number",
    "003": "an ADR number",
    "004": "an ADR number",
    ...
    "95": "the confidence level of every interval",
    "0.084": "the false block rate from the war story, recorded as history",
    "0.055": "the same rate re-measured, recorded as history",
    "0.014": "the standard error of a rate near five percent over 250 draws",
    "0.000": "an effect size row label in the detection table",
    "0.010": "an effect size row label",
    "0.020": "an effect size row label",
    "0.030": "an effect size row label",
    "0.050": "an effect size row label",
    "0.080": "an effect size row label",
    "4.5": "the contrast ratio the screenshot tool enforces",
    "30": "the length in seconds of the defense guide opening",
    "18": "a claim heading and a table position",
    "112": "an item count quoted from a metric, also appearing bare",
    "1608": "an item count quoted from a metric, also appearing bare",
}
